...
// function onOriginalScope(sourceIndex: number, line: number, column: number, fields: number, scopeKind: number, name: number, variables: number[]): void
// fields >= 0 => start of scope
// fields === -1 => end of scope
