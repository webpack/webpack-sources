...
const { streamAndGetSourceAndMap } = require("./helpers/getFromStreamChunks");
...
class CachedSource extends Source {
	...
	streamChunks(options, onChunk, onSource, onName) {
		...
		if (
			...
			if (map) {
				return streamChunksOfSourceMap(source, map, onChunk, onSource, onName);
			} else {
				return streamChunksOfRawSource(source, onChunk, onSource, onName);
			}
		}
		const {
			generatedLine,
