...
class RawSource extends Source {
	 ...
	 * @param {OnOriginalScope=} _onOriginalScope called for each original scope (no scopes on RawSource)
	 * @param {OnGeneratedRange=} _onGeneratedRange called for each generated range (no ranges on RawSource)
