 ...
 * @param {string} innerSourceName the name of the inner source
 * @param {string | undefined} innerSource the inner source
 * @param {object | undefined} innerSourceMap the inner source map
 * @param {boolean} removeInnerSource remove the inner source from the output
 ...
 * @param {boolean} columns true, if columns are used
		...
		(i, source, sourceContent) => {
			if (source === innerSourceName) {
				...
				streamChunksOfSourceMap(
					...
					() => {
						throw new Error("Original scope not supported");
					},
					() => {
						throw new Error("Generated range not supported");
					},
					false,
					columns
				);
