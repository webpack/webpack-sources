 ...
 * @param {OnOriginalScope=} _onOriginalScope on original scope (Scopes Proposal — not supported for combined maps, dropped)
 * @param {OnGeneratedRange=} _onGeneratedRange on generated range (Scopes Proposal — not supported for combined maps, dropped)
